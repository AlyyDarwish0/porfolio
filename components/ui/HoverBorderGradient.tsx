...
>) {
	...
	return (
		<Tag
			...
			className={cn("relative flex rounded-full border-2 border-zinc-500 border-opacity-45 content-center transition duration-500 items-center flex-col flex-nowrap gap-10 h-min justify-center overflow-visible p-px decoration-clone w-fit", containerClassName)}
			{...props}>
			<div className={cn("w-auto text-white z-10 px-4 py-2 rounded-[inherit]", className)}>{children}</div>
			<motion.div
